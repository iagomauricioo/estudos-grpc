...
type ProductServiceClient interface {
	...
	FindById(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*Product, error)
...
func (c *productServiceClient) FindById(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Product)
...
func (UnimplementedProductServiceServer) FindById(context.Context, *ProductId) (*Product, error) {
