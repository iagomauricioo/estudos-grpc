...
type ProductServiceClient interface {
	...
	FindAll(ctx context.Context, in *ProductList, opts ...grpc.CallOption) (*ProductList, error)
}
...
func (c *productServiceClient) FindAll(ctx context.Context, in *ProductList, opts ...grpc.CallOption) (*ProductList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductList)
...
type ProductServiceServer interface {
	...
	FindAll(context.Context, *ProductList) (*ProductList, error)
...
func (UnimplementedProductServiceServer) FindAll(context.Context, *ProductList) (*ProductList, error) {
...
func _ProductService_FindAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).FindAll(ctx, req.(*ProductList))
	}
	return interceptor(ctx, in, info, handler)
}
